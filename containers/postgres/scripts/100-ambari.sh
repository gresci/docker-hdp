...
wget https://raw.githubusercontent.com/apache/ambari/branch-2.6/ambari-server/src/main/resources/Ambari-DDL-Postgres-CREATE.sql
#sed -i "s/\${ambariSchemaVersion}/2.5.2/g" Ambari-DDL-Postgres-CREATE.sql
sed -i "s/\${ambariSchemaVersion}/2.6.3/g" Ambari-DDL-Postgres-CREATE.sql
